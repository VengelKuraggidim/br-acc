...
| camara_goiania | camara_goiania | implemented_partial | partial | web_portal | HTML scraping from https://www.goiania.go.leg.br/institucional/parlamentares/ | Fase 2a (2026-05-02): scraping HTML da listagem 20a Legislatura + 1 GET por perfil; cria :GoVereador rico (party, photo_url, gabinete, phones, email, birth_date, bio_summary) com archival opt-in. Fase 2b pendente: despesas/folha/diarias estao em camaragoiania.nucleogov.com.br (SPA RequireJS, exige Selenium); ver todo-list-prompts/medium_priority/debitos/camara-goiania-scraping.md |
