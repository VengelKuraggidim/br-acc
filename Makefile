...
pre-commit: check neutrality check-public-claims check-pipeline-contracts check-pipeline-inputs check-bootstrap-contract check-provenance-contract
...
check-provenance-contract:
	python3 scripts/check_provenance_contract.py
